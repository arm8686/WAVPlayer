...
#define	MMC_CD		(!GPIO0STAT(7))	/* Card detect (yes:true, no:false, default:true) */
#define	MMC_WP		0						/* Write protected (yes:true, no:false, default:false) */
#define	CS_LOW()	GPIO0LOW(11)	/* Set P0.6 low */
#define	CS_HIGH()	GPIO0HIGH(11)	/* Set P0.6 high */
...
)
{
	...
	LPC_SSP0->CR0 &= ~(0x0F);
	LPC_SSP0->CR0 |= 0x000F;			/* Select 8-bit mode */
}
#endif
